function Gallery(gallery) {
  ...
  this.pervButton = this.modal.querySelector('.prev');
...
Gallery.prototype.openModal = function() {
  ...
  this.pervButton.addEventListener('click', this.showPrevImage);
};
...
Gallery.prototype.closeModal = function() {
  ...
  this.pervButton.removeEventListener('click', this.showPrevImage);
};
